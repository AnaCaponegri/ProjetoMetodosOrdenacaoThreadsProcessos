...
public class ClienteSwing extends JFrame { 
        ...
        SwingWorker<String, Void> worker = new SwingWorker<>() { 
            ...
            protected String doInBackground() throws Exception { 
                ...
                if (isTCP()) { 
                    ...
                    adicionarLog( 
                            "Tentando descobrir servidor via TCP na porta 5000..." 
                    ); 
                    ...
                    adicionarLog( 
                            "Tentando descobrir servidor via UDP na porta 6000..." 
                    ); 
                    ...
                    throw new Exception( 
                            "Porta inválida. Use 5000 para TCP ou 6000 para UDP." 
                    ); 
                } 
            } 
            ...
            protected void done() { 
                ...
                try { 
                    ...
                    adicionarLog( 
                            "Servidor não encontrado: " + e.getMessage() 
                    ); 
        ...
        SwingWorker<String, Void> worker = new SwingWorker<>() { 
            ...
            protected String doInBackground() throws Exception { 
                ...
                if (isTCP()) { 
                    ...
                    throw new Exception( 
                            "Porta inválida. Use 5000 ou 6000." 
                    ); 
                } 
            } 
    ...
    private void baixarArquivoSelecionado() { 
        ...
        String arquivoSelecionado = 
                listaArquivos.getSelectedValue(); 
        ...
        if (!isTCP()) { 
            ...
            JOptionPane.showMessageDialog( 
                    this, 
                    "Download disponível apenas na porta TCP 5000." 
            ); 
